...
file_Dir="/home/carl/FWGNet/labs-example/"
...
# # Run simulation file
sudo ./waf --run "scratch/${file_Simulation}"
# --phyMode=DsssRate2Mbps --rss=-50 --packetSize=500 --numPackets=100 --interval=2 --verbose=true"
